...
BLOG_AUTHOR = "Warut Phothiphan"  # (translatable)
BLOG_TITLE = "Gtopba"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://gtopba.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://gtopba.github.io/"
BLOG_EMAIL = "gtopba@gmail.com"
BLOG_DESCRIPTION = "As I'm getting older, my brain's memory is getting poorer. This blog is my second memory back up."  # (translatable)
